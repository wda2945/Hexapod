local _PACKAGE      = 'lua/behaviortree'
...
BehaviourTree.RepeatWhileFail		  = require(_PACKAGE..'/node_types/repeat_while_fail')
BehaviourTree.RepeatWhileSuccess	  = require(_PACKAGE..'/node_types/repeat_while_success')
