...
int LoadFromFolder(lua_State *L, const char *scriptFolder);	//load chunks
int LoadFromFile(lua_State *L, const char *name, const char *path, int nargs);
...
int LoadFromFolder(lua_State *L, const char *scriptFolder)	//load all scripts in folder
{
	DIR *dp;
	struct dirent *ep;
